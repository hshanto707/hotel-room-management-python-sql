...
class ProfileView:
    def __init__(self, parent, primary_color, secondary_color, session_data=None):
        ...
        # Name
        tk.Label(
            self.frame, text="Name", font=("Helvetica", 12), bg=secondary_color, fg=primary_color
        ).pack(anchor="w")
        ...
        # Password
        tk.Label(
            self.frame, text="Password", font=("Helvetica", 12), bg=secondary_color, fg=primary_color
        ).pack(anchor="w")
        ...
        # Email
        tk.Label(
            self.frame, text="Email", font=("Helvetica", 12), bg=secondary_color, fg=primary_color
        ).pack(anchor="w")
        ...
        # Phone
        tk.Label(
            self.frame, text="Phone", font=("Helvetica", 12), bg=secondary_color, fg=primary_color
        ).pack(anchor="w")
        ...
        # Address
        tk.Label(
            self.frame, text="Address", font=("Helvetica", 12), bg=secondary_color, fg=primary_color
        ).pack(anchor="w")
    ...
    def save_profile(self):
        ...
        # Save the profile details to the database (or session for demo purposes)
        # Here, simulate saving to session or backend logic
